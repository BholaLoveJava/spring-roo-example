...
privileged aspect EmployeesItemJsonController_Roo_JSON {
    ...
    declare @type: EmployeesItemJsonController: @RequestMapping(value = "/employees/{employee}", name = "EmployeesItemJsonController", produces = MediaType.APPLICATION_JSON_VALUE);
